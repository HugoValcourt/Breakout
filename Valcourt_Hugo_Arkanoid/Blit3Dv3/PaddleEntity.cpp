...
PaddleEntity * MakePaddle(float xpos, float ypos, Sprite *sprite, float wbox, float hbox)
{
	...
	boxShape.SetAsBox(wbox / (2.f*PTM_RATIO), hbox / (2.f*PTM_RATIO));
	...
	paddleEntity->body->SetUserData(paddleEntity);
